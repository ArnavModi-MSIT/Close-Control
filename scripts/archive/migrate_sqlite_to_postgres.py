...
wrong rows.
    ...
    python scripts/archive/migrate_sqlite_to_postgres.py --target-database-url postgresql://review_app:review_app_local_dev@localhost:5433/review_queue_dryrun
    python scripts/archive/migrate_sqlite_to_postgres.py --source data/review_queue.db --target-database-url ...
"""
...
DEFAULT_SOURCE = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "data", "review_queue.db")
