...
USAGE
    ...
    python scripts/diff_matcher_runs.py

    # Two explicit code versions (git refs), same dataset:
    python scripts/diff_matcher_runs.py --before-ref HEAD~3 --after-ref HEAD

    # Same code, two datasets (e.g. main demo vs a seed-robustness regen):
    python scripts/diff_matcher_runs.py --before-dir data --after-dir data_seed_1337
