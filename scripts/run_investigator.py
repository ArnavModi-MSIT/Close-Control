...
reliability -- see investigator/config.py).
    ...
    python scripts/run_investigator.py
    python scripts/run_investigator.py --n 5
    python scripts/run_investigator.py --n 5 --concurrency 3   # investigate 3 cases at once instead
                                                        # of one at a time -- see --help
    python scripts/run_investigator.py --transaction-id trn-000001
"""
